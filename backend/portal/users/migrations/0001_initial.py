    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Student', 'Student'), ('Campus Ambassador', 'Campus Ambassador'), ('Admin', 'Admin'), ('Startup', 'Startup'), ('Professional', 'Professional'), ('Contingent', 'Contingent')], max_length=30)),
